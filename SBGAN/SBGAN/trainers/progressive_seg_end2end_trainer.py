    ...
    def test_model(self , global_iteration, n_sample=1000):
        ...
        for i in range(int(n_sample/num_bs)):
            ...
            for j in range(num_bs):
                ...
                save_image(fake_disp_f[j,:,:,:], '/data/test_results/samples/%s/%s_fake_disp_%s_%s.png'%(self.opt.name, i*num_bs+j, self.progressive_model.dim, global_iteration),
                             nrow=1, normalize=True, range=(-1,1))
                
                save_image(fake_im[j,:,:,:], '/data/test_results/samples/%s/%s_im_from_fake_%s_%s.png'%(self.opt.name, i*num_bs+j, self.progressive_model.dim, global_iteration),
                             nrow=1, normalize=True, range=(-1,1))
            ...
            for j in range(num_bs):
                ...
                save_image(fake_im[j,:,:,:], '/data/test_results/samples/%s/%s_im_from_real_%s_%s.png'%(self.opt.name, i*num_bs+j, self.progressive_model.dim, global_iteration),
                             nrow=1, normalize=True, range=(-1,1))
            ...
            for j in range(num_bs):
                ...
                save_image(disp[j,:,:,:], '/data/test_results/samples/%s/%s_real_disp_%s_%s.png'%(self.opt.name, i*num_bs+j, self.progressive_model.dim, global_iteration),
                             nrow=1, normalize=True, range=(-1,1))
